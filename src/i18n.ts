      ...
      articles: [
        {
          ...
          body: [
            ...
            { t: "img", c: "https://nlgfcrkmeslbkqqgatzq.supabase.co/storage/v1/object/public/media/lib/journal-a1-arbitrage-87964e.avif", alt: "Un plan de travail annoté à la main sur un bureau de production, éclairé par une seule lampe.", cap: "Le plan de travail reste l'endroit où se prennent les décisions qui coûtent. Image générée." },
            ...
            { t: "img", c: "https://nlgfcrkmeslbkqqgatzq.supabase.co/storage/v1/object/public/media/lib/journal-a1-plateau-43156c.avif", alt: "Une équipe de tournage réunie autour d'un moniteur de plateau, entre deux prises.", cap: "Entre deux prises, ce qui tient une journée de tournage n'a rien d'automatisable. Image générée." },
            ...
            { t: "img", c: "https://nlgfcrkmeslbkqqgatzq.supabase.co/storage/v1/object/public/media/lib/journal-a1-signature-e1b05f.avif", alt: "Un dossier de production refermé près d'un contrat signé, dans la lumière d'un store.", cap: "Un devis engage une responsabilité juridique et humaine. Elle ne se délègue pas. Image générée." },
          ],
        },
        {
          ...
          body: [
            ...
            { t: "img", c: "https://nlgfcrkmeslbkqqgatzq.supabase.co/storage/v1/object/public/media/lib/journal-a2-mur-c3c319.avif", alt: "Un mur d'images de référence épinglées, dont une seule est entourée au crayon rouge.", cap: "Générer trente variantes est devenu gratuit. Choisir, non. Image générée." },
            ...
            { t: "img", c: "https://nlgfcrkmeslbkqqgatzq.supabase.co/storage/v1/object/public/media/lib/journal-a2-etalonnage-49b73d.avif", alt: "Une suite d'étalonnage dans la pénombre, un seul plan affiché sur le moniteur calibré.", cap: "L'étalonnage reste le moment où une intention devient une image tenue. Image générée." },
            ...
            { t: "img", c: "https://nlgfcrkmeslbkqqgatzq.supabase.co/storage/v1/object/public/media/lib/journal-a2-palette-1636ce.avif", alt: "Une table de direction artistique, nuancier ouvert et compte fils posé sur une planche contact.", cap: "Une palette tenue jusqu'au dernier livrable vaut mieux que trente pistes ouvertes. Image générée." },
          ],
        },
      ],
    },
      ...
      articles: [
        {
          ...
          body: [
            ...
            { t: "img", c: "https://nlgfcrkmeslbkqqgatzq.supabase.co/storage/v1/object/public/media/lib/journal-a1-arbitrage-87964e.avif", alt: "A shooting schedule annotated by hand on a production desk, lit by a single lamp.", cap: "The shooting schedule is still where the expensive decisions get made. Generated image." },
            ...
            { t: "img", c: "https://nlgfcrkmeslbkqqgatzq.supabase.co/storage/v1/object/public/media/lib/journal-a1-plateau-43156c.avif", alt: "A film crew gathered around an on-set monitor between two takes.", cap: "Between takes, what holds a shooting day together is nothing you can automate. Generated image." },
            ...
            { t: "img", c: "https://nlgfcrkmeslbkqqgatzq.supabase.co/storage/v1/object/public/media/lib/journal-a1-signature-e1b05f.avif", alt: "A production folder closed beside a signed contract, in the light of a window blind.", cap: "An estimate commits a legal and human responsibility. That does not get delegated. Generated image." },
          ],
        },
        {
          ...
          body: [
            ...
            { t: "img", c: "https://nlgfcrkmeslbkqqgatzq.supabase.co/storage/v1/object/public/media/lib/journal-a2-mur-c3c319.avif", alt: "A wall of pinned reference images, with only one circled in red pencil.", cap: "Generating thirty variations has become free. Choosing has not. Generated image." },
            ...
            { t: "img", c: "https://nlgfcrkmeslbkqqgatzq.supabase.co/storage/v1/object/public/media/lib/journal-a2-etalonnage-49b73d.avif", alt: "A grading suite in near darkness, a single frame on the calibrated monitor.", cap: "Grading is still the moment an intention becomes an image that holds. Generated image." },
            ...
            { t: "img", c: "https://nlgfcrkmeslbkqqgatzq.supabase.co/storage/v1/object/public/media/lib/journal-a2-palette-1636ce.avif", alt: "An art direction table, an open swatch fan and a loupe resting on a contact sheet.", cap: "A palette held to the last deliverable beats thirty directions left open. Generated image." },
          ],
        },
      ],
    },
